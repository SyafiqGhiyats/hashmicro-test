  ...
  >
    ...
    >
      <input
        ...
        :multiple="multiple"
        @change="onFileChange"
        @click="(e) => ((e.currentTarget as HTMLInputElement).value = '')"
      />
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        <div class="relative mx-auto mt-6 w-full max-w-xl space-y-4">
          ...
          <template v-if="!files.length">
            ...
            <div
              class="absolute inset-0 z-30 mx-auto mt-4 flex h-32 w-full max-w-32 items-center justify-center rounded-md border-2 border-dashed border-sky-400 bg-transparent transition-opacity"
